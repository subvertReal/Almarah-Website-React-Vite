...
function Turban(){
    ...
    useEffect(() => {
        ...
        async function getShowCaseData(){
            ...
            const response = await fetch(jsonData.apiLink+'/scan/turban');
    ...
    return (<>
        ...
        <Container>
            <div className='headerWhitespaceClothingGlobal'>
                <div className='headerClothingGlobal'>Turban</div>
                <Container>
                    <Row>
                    {imgArr.map((image) => (
                        ...
                        <Image className='showcaseoneimg'
                            src={`${jsonData.apiLink}/static/misc/turban/${image.pic1}.webp`}
                            rounded
                        />
