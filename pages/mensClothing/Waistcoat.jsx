...
function Waistcoat(){
    ...
    useEffect(() => {
        ...
        async function getShowCaseData(){
            ...
            const response = await fetch(jsonData.apiLink+'/scan/waistcoat');
    ...
    return (<>
        ...
        <Container>
            <div className='headerWhitespaceClothingGlobal'>
                <div className='headerClothingGlobal'>Waistcoats</div>
                <Container>
                    <Row>
                    {imgArr.map((image) => (
                        ...
                        <Image className='showcaseoneimg'
                            src={`${jsonData.apiLink}/static/menClothing/waistcoat/${image.pic1}.webp`}
                            rounded
                        />
